...
})({"eS6Wa":[function(require,module,exports) {
"use strict";
var HMR_HOST = null;
var HMR_PORT = null;
...
_gsap.gsap.registerPlugin(_scrollTriggerJs.ScrollTrigger);
window.onload = ()=>{
    const cursor = new _cursorDefault.default(document.querySelector(".cursor"));
};
...
locoScroll.on("scroll", _scrollTriggerJs.ScrollTrigger.update);
_scrollTriggerJs.ScrollTrigger.scrollerProxy(scroller, {
    scrollLeft (value) {
...
_scrollTriggerJs.ScrollTrigger.defaults({
    scroller: scroller
});
_scrollTriggerJs.ScrollTrigger.addEventListener("refresh", ()=>locoScroll.update()
);
_scrollTriggerJs.ScrollTrigger.refresh();
...
_scrollTriggerJs.ScrollTrigger.scrollerProxy("[data-scroll-container]", {
    scrollTop (value) {
...
class Cursor {
    ...
    render() {
        ...
        for(const key in this.cursorConfigs)this.cursorConfigs[key].previous = _utils.lerp(this.cursorConfigs[key].previous, this.cursorConfigs[key].current, this.cursorConfigs[key].amt);
...
*/ /* eslint-disable */ var _config = {
    ...
    overwrite: false,
    delay: 0
}, _suppressOverwrites, _reverting, _context, _bigNum = 100000000, _tinyNum = 1 / _bigNum, _2PI = Math.PI * 2, _HALF_PI = _2PI / 4, _gsID = 0, _sqrt = Math.sqrt, _cos = Math.cos, _sin = Math.sin, _isString = function _isString(value) {
...
var _media = [], _listeners = {
}, _emptyArray = [], _lastMediaTime = 0, _dispatch = function _dispatch(type) {
...
var MatchMedia = /*#__PURE__*/ function() {
    ...
    _proto6.add = function add(conditions, func, scope) {
        ...
        var context = new Context(0, scope || this.scope), cond = context.conditions = {
        }, mq, p, active;
...
}, _bigNum = 100000000000000000000, _round = function _round(value) {
...
}, _roundingNum = 100000, _wrapProgress = function _wrapProgress(progress) {
...
function sliceRawPath(rawPath, start, end) {
    ...
    if (wrap || loops) {
        ...
        if (Math.abs(1 - (end - start)) < 0.00001) eSegIndex = sSegIndex - 1;
...
_listeners = {
}, _emptyArray = [], _softRefresh = function _softRefresh1() {
...
var ScrollTrigger = /*#__PURE__*/ function() {
    ...
    _proto.init = function init(vars, animation) {
        ...
        }, getScrollerSize = _getSizeFunc(scroller, isViewport, direction), getScrollerOffsets = _getOffsetsFunc(scroller, isViewport), lastSnap = 0, lastRefresh = 0, scrollFunc = _observerJs._getScrollFunc(scroller, direction), tweenTo, pinCache, snapFunc, scroll1, scroll2, start, end, markerStart, markerEnd, markerStartTrigger, markerEndTrigger, markerVars, change, pinOriginalState, pinActiveState, pinState, spacer, offset1, pinGetter, pinSetter, pinStart, pinChange, spacingStart, spacerState, markerStartSetter, pinMoves, markerEndSetter, cs1, snap1, snap2, scrubTween, scrubSmooth, snapDurClamp, snapDelayedCall, prevProgress1, prevScroll, prevAnimProgress, caMarkerSetter, customRevertReturn;
        _context(self);
        self._dir = direction;
        anticipatePin *= 45;
        ...
        self.refresh = function(soft, force) {
            ...
            if (prevProgress1 !== self.progress || containerAnimation) {
                ...
                self.progress = (scroll1 - start) / change === prevProgress1 ? 0 : prevProgress1;
            }
...
*/ /* eslint-disable */ var gsap, _coreInitted, _clamp, _win, _doc, _docEl, _body, _isTouch, _pointerType, ScrollTrigger, _root, _normalizer, _eventTypes, _context, _getGSAP = function _getGSAP() {
    ...
    var core = ScrollTrigger.core, data = core.bridge || {
    }, scrollers = core._scrollers, proxies = core._proxies;
...
var Observer = /*#__PURE__*/ function() {
    ...
    _proto.init = function init(vars) {
        ...
        tolerance = tolerance || 0.000000001;
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["eS6Wa","97hsZ"], "97hsZ", "parcelRequireda23")
